...
- **Update** 외부 adapter 후속: Java 실제 PIT CLI 실행 상태를 반영. 별도 프로브·제한 profile·미승인 경계 유지.
- **Update** 검토·검증: Java 소스·도구·후보 목록 무결성을 보강. Java 전체 함수 670개 CRAP 통과, Java 테스트 232개 통과.
- **Creation** external-adapter-progress.md: Java 보고서 연결의 작업 의존, 미완료 승인 조건과 후속 순서 기록.
- **Update** index.md·후보 평가: 9월 7일 조사와 9월 8일 구현 진행을 구분해 연결. 기존 backend 승인 기록은 유지.

## 2026-09-07

- **Creation** mutation-backend-evaluation.md: Certitude·PIT·ArcMutate·Stryker 비교와 실측, 외부 개발자 근거, adapter 도입 조건 기록.
